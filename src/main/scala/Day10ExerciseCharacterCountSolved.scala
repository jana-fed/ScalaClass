...
object Day10ExerciseCharacterCountSolved extends App {
  ...
  MyUtil.printDeltaMs(t0, t1, 3,"Counting by actually counting each char")

  val t2 = System.nanoTime()
  val resMap2 = countCharsByBuckets(longText)
  val t3 = System.nanoTime()
  MyUtil.printDeltaMs(t2, t3, 3, "Counting by buckets")
  ...
  MyUtil.printDeltaMs(t4, t5, 3, "Counting by buckets huge text")
  println(resMap3)

  val t6= System.nanoTime()
  val resMap4= countCharsByBuckets(hugeText, lower=true)
  val t7 = System.nanoTime()
  MyUtil.printDeltaMs(t6, t7, 3, "Counting by buckets huge text lower only")
  println(resMap4)
}
